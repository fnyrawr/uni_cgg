...
public class PlaneWinnerRadius implements Shape {
     ...
     */
    public PlaneWinnerRadius(Point point, Direction normal, double outerRadius, double innerRadius, Material material) {
        this.point = point;
        this.normal = normal;
        this.outerRadius = outerRadius;
        this.innerRadius = innerRadius;
        this.material = material;
        this.boundingBox = new BoundingBox(Vector.add(Vector.direction(-outerRadius, -0.001, -outerRadius), point),
